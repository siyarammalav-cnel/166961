          ...
          <?php if( get_theme_mod( 'auto_parts_garage_toggle_postdate',true) == 1 || get_theme_mod( 'auto_parts_garage_toggle_author',true) == 1 || get_theme_mod( 'auto_parts_garage_toggle_comments',true) == 1 || get_theme_mod( 'auto_parts_garage_toggle_time',true) == 1) { ?>
            <div class="post-info p-2 mb-3">
              <?php if(get_theme_mod('auto_parts_garage_toggle_postdate',true)==1){ ?>
                <i class="<?php echo esc_attr(get_theme_mod('auto_parts_garage_toggle_postdate_icon','fas fa-calendar-alt')); ?> me-2"></i><span class="entry-date"><a href="<?php echo esc_url( get_day_link( $auto_parts_garage_archive_year, $auto_parts_garage_archive_month, $auto_parts_garage_archive_day)); ?>"><?php echo esc_html( get_the_date() ); ?><span class="screen-reader-text"><?php echo esc_html( get_the_date() ); ?></span></a></span><span><?php echo esc_html(get_theme_mod('auto_parts_garage_meta_field_separator', '|'));?></span>
              <?php } ?>

              <?php if(get_theme_mod('auto_parts_garage_toggle_author',true)==1){ ?>
                <i class="<?php echo esc_attr(get_theme_mod('auto_parts_garage_toggle_author_icon','fas fa-user')); ?> me-2"></i><span class="entry-author"><a href="<?php echo esc_url( get_author_posts_url( get_the_author_meta( 'ID' )) ); ?>"><?php the_author(); ?><span class="screen-reader-text"><?php the_author(); ?></span></a></span><span><?php echo esc_html(get_theme_mod('auto_parts_garage_meta_field_separator', '|'));?></span>
              <?php } ?>

              <?php if(get_theme_mod('auto_parts_garage_toggle_comments',true)==1){ ?>
                <i class="<?php echo esc_attr(get_theme_mod('auto_parts_garage_toggle_comments_icon','fa fa-comments')); ?> me-2" aria-hidden="true"></i><span class="entry-comments"><?php comments_number( __('0 Comment', 'auto-parts-garage'), __('0 Comments', 'auto-parts-garage'), __('% Comments', 'auto-parts-garage') ); ?></span><span><?php echo esc_html(get_theme_mod('auto_parts_garage_meta_field_separator', '|'));?></span>
              <?php } ?>

              <?php if(get_theme_mod('auto_parts_garage_toggle_time',true)==1){ ?>
                <i class="<?php echo esc_attr(get_theme_mod('auto_parts_garage_toggle_time_icon','fas fa-clock')); ?> me-2"></i><span class="entry-time"><?php echo esc_html( get_the_time() ); ?></span>
              <?php } ?>
