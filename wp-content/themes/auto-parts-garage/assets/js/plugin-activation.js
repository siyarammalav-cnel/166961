jQuery(document).ready(function($) {
    'use strict';
    var this_obj = auto_parts_garage_plugin_activate_plugin;

    $('#gutenberg_editor .plugin-activation-redirect a').addClass('ive-redirect-to-dashboard');

    $(document).on('click', '.auto-parts-garage-plugin-install', function(event) {
        ...
        wp.updates.installPlugin({
            ...
            success: function(data) {
                ...
                button.removeClass('button-secondary updating-message auto-parts-garage-plugin-install');
                button.addClass('button-primary auto-parts-garage-plugin-activate');
                button.trigger('click');
            },
            error: function(data) {
                jQuery('.auto-parts-garage-recommended-plugins .auto-parts-garage-activation-note').css('display','block');
    ...
    $(document).on('click', '.auto-parts-garage-plugin-activate', function(event) {
    ...
    jQuery('#lite_theme .ibtana-skip-btn').click(function(){
        ...
        jQuery('#lite_theme .auto-parts-garage-recommended-plugins').css('display','none');
    });

    jQuery('#block_pattern .ibtana-skip-btn').click(function(){
        var light_theme = jQuery(this).attr('get-start-tab-id');
        jQuery('.' + light_theme).css('display','block');
        jQuery('#block_pattern .auto-parts-garage-recommended-plugins').css('display','none');
    });
