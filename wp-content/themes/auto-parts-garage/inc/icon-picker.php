...
class Auto_Parts_Garage_Fontawesome_Icon_Chooser extends WP_Customize_Control{
    public $type = 'icon';
        ...
        ?>
            <label>
                ...
                <div class="social-icon-search">
                    <input class="socialInput" type="text" placeholder="<?php echo esc_attr_x( 'Icon', 'placeholder', 'auto-parts-garage' ); ?>">
                </div>
                ...
                <ul class="icon-list clearfix">
                    <?php
                    $auto_parts_garage_font_awesome_icon_array = auto_parts_garage_font_awesome_icon_array();
                    foreach ($auto_parts_garage_font_awesome_icon_array as $auto_parts_garage_font_awesome_icon) {
                            $icon_class = $this->value() == $auto_parts_garage_font_awesome_icon ? 'icon-active' : '';
                            echo '<li class='.esc_attr($icon_class).'><i class="'.esc_attr($auto_parts_garage_font_awesome_icon).'"></i>
                            <span class="auto-parts-garage-social-class">'.esc_attr($auto_parts_garage_font_awesome_icon).'</span>
                            </li>';
                        }
                    ?>
                </ul>
...
function auto_parts_garage_customizer_script() {
     
    wp_enqueue_style( 'font-awesome-1', esc_url(get_template_directory_uri()).'/assets/css/fontawesome-all.css');
    wp_enqueue_script( 'auto-parts-garage-customizer-script', esc_url(get_template_directory_uri()).'/assets/js/customizer-scripts.js', array("jquery"),'', true  );
}
add_action( 'customize_controls_enqueue_scripts', 'auto_parts_garage_customizer_script' );

if(!function_exists('auto_parts_garage_font_awesome_icon_array')){
    function auto_parts_garage_font_awesome_icon_array(){
