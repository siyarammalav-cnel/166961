...
class Auto_Parts_Garage_About_Widget extends WP_Widget {
	function __construct() {
		parent::__construct(
			'Auto_Parts_Garage_About_Widget',
			__('VW About us', 'auto-parts-garage'),
			array( 'description' => __( 'Widget for about us section in sidebar', 'auto-parts-garage' ), ) 
		);
	}
	...
	?>
    	...
    	<p>
        <label for="<?php echo esc_attr($this->get_field_id('author')); ?>"><?php esc_html_e('Author Name:','auto-parts-garage'); ?></label>
    	...
    	<p>
        <label for="<?php echo esc_attr($this->get_field_id('designation')); ?>"><?php esc_html_e('Designation:','auto-parts-garage'); ?></label>
    	...
    	<p>
        <label for="<?php echo esc_attr($this->get_field_id('description')); ?>"><?php esc_html_e('Description:','auto-parts-garage'); ?></label>
    	...
    	<p>
		<label for="<?php echo esc_attr($this->get_field_id('read_more_text')); ?>"><?php esc_html_e('Button Text:','auto-parts-garage'); ?></label>
		...
		<p>
		<label for="<?php echo esc_attr($this->get_field_id('read_more_url')); ?>"><?php esc_html_e('Button Url:','auto-parts-garage'); ?></label>
		...
		<p>
		<label for="<?php echo esc_attr($this->get_field_id( 'upload_image' )); ?>"><?php esc_html_e( 'Image Url:','auto-parts-garage'); ?></label>
		<?php
			if ( $upload_image != '' ) :
...
function auto_parts_garage_about_custom_load_widget() {
	register_widget( 'Auto_Parts_Garage_About_Widget' );
}
add_action( 'widgets_init', 'auto_parts_garage_about_custom_load_widget' );