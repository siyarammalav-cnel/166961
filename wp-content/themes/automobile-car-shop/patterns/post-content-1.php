 ...
 * Slug: automobile-car-shop/post-content-1
 * Categories: template
 */
?>
...
<main class="wp-block-group">
	...
	<div class="wp-block-group">
		<!-- wp:post-featured-image {"align":"wide","style":{"spacing":{"margin":{"bottom":"0px","top":"0px","right":"0px","left":"0px"}}}} /-->
		...
		<hr
			class="wp-block-separator has-css-opacity alignwide is-style-wide"
		/>
		<!-- /wp:separator -->
	</div>
	<!-- /wp:group -->
	...
	<!-- wp:pattern {"slug":"automobile-car-shop/comment-section-1"} /-->
</main>
<!-- /wp:group -->
