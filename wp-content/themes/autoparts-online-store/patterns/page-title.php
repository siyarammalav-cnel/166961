...
/**
 * Title: Page Title
 * Slug: autoparts-online-store/page-title
 * Categories: autoparts-online-store, page-title
 */
?>

<!-- wp:group {"tagName":"main","style":{"spacing":{"margin":{"top":"0px","bottom":"0px"}}},"layout":{"type":"default"}} -->
<main class="wp-block-group" style="margin-top:0px;margin-bottom:0px"><!-- wp:cover {"url":"<?php echo esc_url( get_template_directory_uri() . '/images/bg_breadcrumb_v2.jpg'); ?>","id":76,"dimRatio":0,"minHeight":300} -->
