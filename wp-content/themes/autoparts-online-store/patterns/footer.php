...
/**
 * Title: Footer
 * Slug: autoparts-online-store/footer
 * Categories: autoparts-online-store, footer
 */
?>

<!-- wp:group {"style":{"spacing":{"padding":{"top":"60px","right":"20px","bottom":"60px","left":"20px"},"margin":{"top":"0","bottom":"0"},"blockGap":"0"},"color":{"background":"#181818"}},"textColor":"white","layout":{"type":"constrained","contentSize":"90%"},"fontSize":"small"} -->
<div class="wp-block-group has-white-color has-text-color has-background has-small-font-size" style="background-color:#181818;margin-top:0;margin-bottom:0;padding-top:60px;padding-right:20px;padding-bottom:60px;padding-left:20px"><!-- wp:group {"align":"wide","style":{"elements":{"link":{"color":{"text":"var:preset|color|Background"}}},"spacing":{"margin":{"top":"0px","bottom":"0px"}}},"textColor":"Background","layout":{"type":"default"}} -->
...
<!-- wp:group {"style":{"spacing":{"padding":{"top":"20px","right":"20px","bottom":"20px","left":"20px"}}},"backgroundColor":"luminous-vivid-amber","textColor":"white","layout":{"type":"constrained","contentSize":"90%"}} -->
<div class="wp-block-group has-white-color has-luminous-vivid-amber-background-color has-text-color has-background" style="padding-top:20px;padding-right:20px;padding-bottom:20px;padding-left:20px"><!-- wp:group {"align":"wide","layout":{"type":"default"}} -->
...
<p class="has-background-color has-text-color has-merriweather-font-family">© Copyright 2023. All Rights Reserved.</p>
<!-- /wp:paragraph -->
...
<p class="has-background-color has-text-color has-link-color has-merriweather-font-family">Proudly powered by <a rel="noreferrer noopener" href="https://templatehouse.net/" target="_blank">AutoParts Online Store Themes</a> and <a href="https://wordpress.org">WordPress</a>.</p>
<!-- /wp:paragraph --></div>
<!-- /wp:group --></div>
<!-- /wp:group --></div>
<!-- /wp:group -->